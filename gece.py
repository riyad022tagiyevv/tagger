  ...
  if event.is_private:
    async for usr in client.iter_participants(event.chat_id):
     ...
     return await event.reply(f"{ad} {startmesaj}", buttons=(
                      [
                       Button.url('🎉  Meni Qr𝗎𝖻𝖺 𝖤𝗄𝗅𝖾  🎉', f'https://t.me/{USERNAME}?startgroup=a')],
                      [
                       Button.url('📚  Əmirlər  ', f'https://t.me/RiyaddBlogg'),
                       Button.url('👨‍💻  𝖮𝗐𝗇𝖾𝗋  ', f'https://t.me/RiyadAndMe')],
...
async def handler(event):
    async for usr in client.iter_participants(event.chat_id):
     ...
     await event.edit(f"{ad} {startmesaj}", buttons=(
                      [
                       Button.url('🎉  Me𝗇𝗂 Q𝗋𝗎𝖻𝖺 𝖤𝗄𝗅𝖾  🎉', f'https://t.me/{USERNAME}?startgroup=a')],
                      [Button.url("📚  𝖪𝗈𝗆𝗎𝗍𝗅𝖺𝗋  ", f'https://t.me/RiyaddBlogg'),
                       Button.url('👨‍💻  𝖮𝗐𝗇𝖾𝗋  ', f'https://t.me/RiyadAndMe')]
                       [Button.url('📝  𝖢𝗁𝖺𝗇𝗇𝖾𝗅  ', f'https://t.me/{support}')]
                    ),
                    link_preview=False)
...
async def handler(event):
    await event.edit(f"{komutlar}", buttons=(
                      [
                      Button.url('📣  𝖲𝗎𝗉𝗉𝗈𝗋𝗍  ', f'https://t.me/Momento_More0088'),
...
print(">> Bot çalışmaktadir merak etme 🚀 @RiyadAndMe bilgi alabilirsin. <<")
